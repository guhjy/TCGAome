...
RPPA_ANNOTATIONS = list(
  ...
  # removed as it has no RNAseq "ESCA" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/ESCA/20150821/gdac.broadinstitute.org_ESCA.RPPA_AnnotateWithGene.Level_3.2015082100.1.0.tar.gz",
  ...
  # removed as there is no RPPA data "KICH" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/KICH/20150821/gdac.broadinstitute.org_KICH.RPPA_AnnotateWithGene.Level_3.2015082100.1.0.tar.gz",
  ...
  # remove due to incoherent annotations and impl "LGG" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/LGG/20150821/gdac.broadinstitute.org_LGG.RPPA_AnnotateWithGene.Level_3.2015082100.0.0.tar.gz",
  # removed as there is no RPPA data "LIHC" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/LIHC/20150821/gdac.broadinstitute.org_LIHC.RPPA_AnnotateWithGene.Level_3.2015082100.1.0.tar.gz",
  ...
  # removed as there is no RPPA data "MESO" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/MESO/20150821/gdac.broadinstitute.org_MESO.RPPA_AnnotateWithGene.Level_3.2015082100.1.0.tar.gz",
  ...
  # removed as there is no RPPA data  "PRAD" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/PRAD/20150821/gdac.broadinstitute.org_PRAD.RPPA_AnnotateWithGene.Level_3.2015082100.0.0.tar.gz",
  ...
  # removed for strange error"SARC" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/SARC/20150821/gdac.broadinstitute.org_SARC.RPPA_AnnotateWithGene.Level_3.2015082100.1.0.tar.gz",
  ...
  # remove due to incoherent annotations and impl"STAD" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/STAD/20150821/gdac.broadinstitute.org_STAD.RPPA_AnnotateWithGene.Level_3.2015082100.0.0.tar.gz",
  ...
  # remove due to incoherent annotations and impl"THCA" = "http://gdac.broadinstitute.org/runs/stddata__2015_08_21/data/THCA/20150821/gdac.broadinstitute.org_THCA.RPPA_AnnotateWithGene.Level_3.2015082100.1.0.tar.gz",
