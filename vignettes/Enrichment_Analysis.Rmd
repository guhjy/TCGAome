...
```{r, warning=FALSE, message=FALSE}
kegg_term_clustering <- TCGAome::TermsClustering(kegg_enrichment, "UI", significance_thr = 0.05, adj_method = "none")
...
kegg_term_clustering <- TCGAome::get_terms_clustering(kegg_enrichment, "UI", significance_thr = 0.05, adj_method = "none")
```
